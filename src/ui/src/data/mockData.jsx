...
export const expenses = [
  { id: 'EXP-102', vendor: 'Indie Cowork', amount: 5200, category: 'Kontorplass', date: '2025-02-06' },
  { id: 'EXP-103', vendor: 'Vy', amount: 1850, category: 'Reise', date: '2025-02-09' },
  { id: 'EXP-104', vendor: 'Fram Creative', amount: 4200, category: 'Underleverandør', date: '2025-02-12' },
  { id: 'EXP-105', vendor: 'Staples', amount: 750, category: 'Kontorrekvisita', date: '2025-02-13' }
];
...
export const activityFeed = [
  {
    ...
    detail: 'Faktura 2025-004 · Nord Design Studio',
    time: 'for 2 t siden',
    amount: 87000,
    status: 'success'
  },
  {
    id: 'act-2',
    title: 'Purring sendt',
    detail: 'Faktura 2025-003 · Fjord Tech',
    time: 'for 5 t siden',
    status: 'warn'
  },
  {
  ...
  {
    id: 'act-4',
    title: 'Budsjettår oppdatert',
    detail: 'Syklus 2024/2025',
...
export const clientHighlights = [
  { name: 'Nord Design Studio', value: 87000, meta: 'Fast avtale · +18% k/k' },
  { name: 'Oslo Creative', value: 46000, meta: 'Produktdesign · På plan' },
  { name: 'Fjord Tech', value: 120000, meta: 'Entreprise · Forfalt' }
];
